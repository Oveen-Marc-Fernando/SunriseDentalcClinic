 ...
 * @author oveen
 */
public class OS_PM_3 extends javax.swing.JFrame {
    ...
    public OS_PM_3(PatientManagementController controller) {
    ...
    private void populateFieldsFromModel() {
        ...
        if (m.getBloodGroup() != null) cmbBloodGroup.setSelectedItem(m.getBloodGroup());
    ...
    private void initComponents() {
        ...
        setTitle("Sunrise Dental – Patient Management (Step 3)");
        setResizable(false);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        controller.goNextFromStep3(
                cmbBloodGroup.getSelectedItem() != null ? cmbBloodGroup.getSelectedItem().toString() : "",
