 ...
 */
public class OS_DM_3 extends javax.swing.JFrame {

    private final DentistManagementController controller;

    public OS_DM_3(DentistManagementController controller) {
    ...
    private void initComponents() {
        ...
        setTitle("Sunrise Dental – Dentist Management (Step 3)");
        setResizable(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new OS_DM_3(new controller.DentistManagementController()).setVisible(true));
    }
