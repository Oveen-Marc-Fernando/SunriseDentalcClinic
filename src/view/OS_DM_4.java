...
/**
 * Step 4: Employment Information Form
 * View only — all logic delegated to DentistManagementController.
 */
public class OS_DM_4 extends javax.swing.JFrame {

    private final DentistManagementController controller;

    public OS_DM_4(DentistManagementController controller) {
    ...
    private void initComponents() {
        ...
        cmbEmploymentType = new javax.swing.JComboBox<String>();
        ...
        setTitle("Sunrise Dental – Dentist Management (Step 4)");
        setResizable(false);
        ...
        lblSubtitle.setText("Employment Information");
        ...
        cmbEmploymentType.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "General Dentist", "Specialist", "Consultant", "Resident" }));
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        controller.goNextFromStep4(
                ...
                (String) cmbEmploymentType.getSelectedItem(),
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new OS_DM_4(new controller.DentistManagementController()).setVisible(true));
    }
    ...
    private javax.swing.JComboBox<String> cmbEmploymentType;
