...
/**
 * My Profile — Step 2: My Professional Information
 * View only — all logic delegated to DentistProfileController.
 */
public class D_Profile_2 extends javax.swing.JFrame {

    private final DentistProfileController controller;

    public D_Profile_2(DentistProfileController controller) {
    ...
    private void prefillFromModel() {
        ...
        if (m == null) return;
        if (m.getSlmcNo() != null)         txtSlmcNo.setText(m.getSlmcNo());
        if (m.getQualification() != null)  txtQualification.setText(m.getQualification());
        if (m.getUniversity() != null)     txtUniversity.setText(m.getUniversity());
        if (m.getGraduationYear() != null) txtGradYear.setText(m.getGraduationYear());
        if (m.getSpecialization() != null) txtSpecialization.setText(m.getSpecialization());
        if (m.getExperience() != null)     txtExperience.setText(m.getExperience());
        if ("Active".equals(m.getLicenseStatus()))   chkActive.setSelected(true);
        if ("Inactive".equals(m.getLicenseStatus())) chkInactive.setSelected(true);
    }
    ...
    private void initComponents() {
        ...
        lblSubtitle.setText("My Professional Information");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new D_Profile_2(new controller.DentistProfileController(null)).setVisible(true));
    }
